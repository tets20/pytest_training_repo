...
def test_add_contact(app):
    ...
    app.create_contact(Kontact(firstname="Test_contact", middlename="Test_contact", lastname="Test_contact",
...
def test_add_empty_contact(app):
    app.login( username="admin", password="secret")
    app.create_contact(Kontact(firstname="", middlename="", lastname="", nickname="", title="", company="",
